...
int main(int argc, char** argv) {
    ...
    if (!strcmp(argv[1], "-DENSO")) {
        ...
        float** matrix_CSR = (float**) calloc(3 , sizeof (float*));
        matrix_CSR[0] = (float*) calloc(quantity_non_zeros , sizeof (float));
        matrix_CSR[1] = (float*) calloc(quantity_non_zeros , sizeof (float));
        matrix_CSR[2] = (float*) calloc((length_matrix + 1) , sizeof (float));
        
    	float *AA = (float*) calloc(quantity_non_zeros , sizeof (float));
    	float *JA = (float*) calloc(quantity_non_zeros , sizeof (float));
    	float *IA = (float*) calloc((length_matrix+ 1) , sizeof (float));
    	
        create_matrix_CSR(file,matrix_CSR,AA,JA,IA);
